...
// 						Sop2Top::fillBuffer(buf, 0, info.textureDesc.width, info.textureDesc.height, myStep, brightness);
...
void
Sop2Top::fillAndUpload(TOP_Output* output, double speed, int width, int height, OP_TexDim texDim, int numLayers, int colorBufferIndex)
{
	TOP_UploadInfo info;
...
void
Sop2Top::fillBuffer(OP_SmartRef<TOP_Buffer>& buf, uint64_t byteOffset, int width, int height, double step, double brightness)
{
